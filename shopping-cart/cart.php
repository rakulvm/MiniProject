...
<head>
  <meta charset="UTF-8">
  <meta name="author" content="Rakul">
  ...
  echo $_SESSION['message'];
        ...
        <tbody>
              ...
              <tr>
                ...
                <td><?= $row['cropname'] ?></td>
                <td>
                  <i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['amount'],2); ?>
                </td>
                <input type="hidden" class="amount" value="<?= $row['amount'] ?>">
                <td>
                <?= $row['sellername'] ?>
                </td>
                <td>
                <?= $row['selleraddress'] ?></td>
                </td>
                <td>
                <?= $row['selleremail'] ?></td>
                </td>
                <td>
                <?= $row['sellercontact'] ?></td>
                </td>
                <td><i class="fas fa-rupee-sign"></i>&nbsp;&nbsp;<?= number_format($row['amount'],2); ?></td>
                <td>
