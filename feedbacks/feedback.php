...
<head>
    <meta charset="UTF-8">
    <title>Farmer's Market feedback</title>
    <link rel="stylesheet" href="styles.css">
    <!-- bootstrap cdn link -->
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="import" href="https://fonts.googleapis.com/css?family=Poppins:400,500,600,700&display=swap">
</head>
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-4 offset-md-4 mail-form">
                       ...
                       if(empty($recipient) || empty($subject) || empty($message)){
                           ...
                           if(mail($recipient, $subject, $message, $sender)){
                            ...
                            <div class="alert alert-success text-center">
                                <?php echo "Your feedback is successfully sent to our administrator"?>
                            </div>
                           <?php
                           $recipient = "";
                           }else{
                ...
                <form action="feedback.php" method="POST">
                    ...
                    <div class="form-group">
                        <textarea cols="30" rows="5" class="form-control textarea" name="message" placeholder="Tell us your experience on the webpage"></textarea>
                    </div>
                    <div class="form-group">
